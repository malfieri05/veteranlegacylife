...
class IULQuoteSlider {
    ...
    getIULQuote() {
        try {
            ...
            console.log(`🔍 calculateIULQuote called with: coverageAmount=${coverage}, age=${age}, gender=${gender}`);
            ...
            for (let i = 0; i < sortedRanges.length; i++) {
                ...
                console.log(`🔍 Checking range ${range}: ${minCoverage}-${maxCoverage}, coverageAmount=${coverage}`);
                ...
                if (coverage >= minCoverage && coverage <= maxCoverage) {
                    ...
                    if (coverage === minCoverage || coverage === maxCoverage) {
                        ...
                        console.log(`✅ Exact match at boundary - Coverage: ${coverage}, Premium: ${selectedPremium}`);
                    } else {
            ...
            console.log(`💰 IUL Quote calculated - Age: ${age} (${ageBracket}), Gender: ${gender}, Coverage: ${coverage}, Premium: ${selectedPremium}`);
